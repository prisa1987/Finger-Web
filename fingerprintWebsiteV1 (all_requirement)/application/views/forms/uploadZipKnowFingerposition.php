	...
	<div id="container">
		...
		<div id="body" class="body">
			<div class="panel panel-default" id="title" class="title">
		     ...
		     <?php echo form_open_multipart('main/uploadZip');?> 
									...
									<tr>
									    <td>
											<div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','R0')">
										     	<div class="uploadarea">
													...
													<div class="drop" id="R0" >
														<?php if(isset($R0_path)){ ?>
														<img id="e" src=<?php echo base_url($R0_path); ?> width="200px" height="200px"/> <?php } ?>
									    ...
									    <td>
										    <div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','R1')">
										     	<div class="uploadarea">
													<div class="drop" id="R1" >
														<?php if(isset($R1_path)){ ?>
														<img id="e" src=<?php echo base_url($R1_path); ?> width="200px" height="200px"/> <?php } ?>
													</div>
									    ...
									    <td>
										   <div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','R2')">
										     	<div class="uploadarea">
													<div class="drop" id="R2" >
														<?php if(isset($R2_path)){ ?>
														<img id="e" src=<?php echo base_url($R2_path); ?> width="200px" height="200px"/> <?php } ?>
													</div>
									    ...
									    <td>
										   <div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','R3')">
										      	<div class="uploadarea">
													<div class="drop" id="R3" >
														<?php if(isset($R3_path)){ ?>
														<img id="e" src=<?php echo base_url($R3_path); ?> width="200px" height="200px"/> <?php } ?>
													</div>
									    ...
									    <td>
										    <div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','R4')">
										      	<div class="uploadarea">
													<div class="drop" id="R4" >
														<?php if(isset($R4_path)){ ?>
														<img id="e" src=<?php echo base_url($R4_path); ?> width="200px" height="200px"/> <?php } ?>
													</div>
									...
									<tr>
										<td>
											<div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','L0')">
										     	<div class="uploadarea">
													...
													<div  class="drop" id="L0">
														<?php if(isset($L0_path)){ ?>
														<img id="e" src=<?php echo base_url($L0_path); ?> width="200px" height="200px"/> <?php } ?>
													</div>
									    ...
									    <td>
									    	<div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','L1')">
										     	<div class="uploadarea">
													<div  class="drop" id="L1" >
														<?php if(isset($L1_path)){ ?>
														<img id="e" src=<?php echo base_url($L1_path); ?> width="200px" height="200px"/> <?php } ?>
													</div>
									    ...
									    <td>
									    	<div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','L2')">
										     	...
										     	<div class="uploadarea">
													<div  class="drop" id="L2" >
															<?php if(isset($L2_path)){ ?>
														<img id="e" src=<?php echo base_url($L2_path); ?> width="200px" height="200px"/> <?php } ?>
													</div>
									    ...
									    <td>
									    	<div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','L3')">
										      	<div class="uploadarea">
													<div  class="drop" id="L3" >
															<?php if(isset($L23path)){ ?>
														<img id="e" src=<?php echo base_url($L3_path); ?> width="200px" height="200px"/> <?php } ?>
													</div>
									    ...
									    <td>
									    	<div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','L4')">
										      	...
										      	<div class="uploadarea">
													<div  class="drop" id="L4" >
															<?php if(isset($L4_path)){ ?>
														<img id="e" src=<?php echo base_url($L4_path); ?> width="200px" height="200px"/> <?php } ?>
													</div>
