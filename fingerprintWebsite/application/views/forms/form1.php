                ...
                <div class="panel-body" id="content" name="content">
                	<div id="form" name="form">
	                	...
	                	<div class="form-inline" name="header" id="header">
							...
							<input class="form-control col-xs-6" type="date" name="fingerprint_date" id="fingerprint_date" >
							<br>
							<label class="col-xs-6" for="department">ส่วนราชการ *</label>
							<input class="form-control col-xs-6" type="text" name="department" id="department"> 
						</div>
						<br>
						<div class="form-horizontal" id="detail" name="detail">
							<div class="form-horizontal" name="criminal" id="criminal">
								<label class="bold" for="criminal" class="bold"><b>ผู้ถูกพิมพ์ลายนิ้วมือ </b></label>
								<br>
								<div class="form-inline">
									<label class="col-md-6" for="criminal_sex">เพศ *</label>
									<select class="form-control col-md-6"  id="criminal_sex" name="criminal_sex">
								...
								<div class="form-inline">
									...
									<input class="form-control col-md-6" type="text" name="criminal_name" id="criminal_name">
									<br>
									<label class="col-md-6" for="criminal_surname">นามสกุล *</label>
									<input class="form-control col-md-6" type="text" name="criminal_surname" id="criminal_surname" >
								</div>
							</div>
							<br>
							<div class="form-horizontal" name="officer" id="officer">
								...
								<div class="form-inline">
									...
									<input class="form-control col-md-6" type="text" name="officer_name" id="officer_name">
									<br>
									<label class="col-md-6" for="officer_surname">นามสกุล *</label>
									<input class="form-control col-md-6" type="text" name="officer_surname" id="officer_surname" >
								</div>
							</div>
							<br>
							<div class="form-horizontal"  id="other" name="other">
								<div class="form-inline">
									...
									<input class="form-control col-md-6" type="text" name="history_number" id="history_number">
								</div>
								<div class="form-inline">
									<label class="col-md-6" for="fingerprint_code">รหัสลายพิมพ์นิ้วมือ</label>
									<input class="form-control col-md-6" type="text" name="fingerprint_code" id="fingerprint_code">					
								</div>
								<div class="form-inline">
									<label class="col-md-6" for="other_code">แยกรหัสอื่น</label>
									<input class="form-control col-md-6" type="text" name="other_code" id="other_code">
								</div>
							</div>
							<br>
							<label class="col-xs-6" id="star" name="star">ช่องที่มีเครื่องหมาย * ต้องกรอกให้ครบ</label>
