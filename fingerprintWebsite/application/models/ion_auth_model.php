...
class Ion_auth_model extends CI_Model
{
	...
	{
		// echo "<script type='text/javascript'>alert('pass= '.$password.'   salt= '.$salt);</script>";
		if (empty($password))
		{
			return FALSE;
		}
		...
		{
			// echo "<script type='text/javascript'>alert('bcrypt');</script>";
		...
		{
			// echo "<script type='text/javascript'>alert('sha1(password.salt)');</script>";
