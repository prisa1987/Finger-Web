...
CREATE TABLE `form` (
    ...
    `fingerprint_date` varchar(15) NOT NULL,
    `department` varchar(30) NOT NULL,
    `criminal_sex` varchar(30) NOT NULL,
    `yearofbirth` varchar(30) NOT NULL,
    `criminal_name` varchar(30) NOT NULL,
    `criminal_surname` varchar(30) NOT NULL,
    `officer_name` varchar(30) NOT NULL,
    `officer_surname` varchar(30) NOT NULL,
    `history_number` varchar(30) DEFAULT NULL,
    `fingerprint_code` varchar(30) DEFAULT NULL,
    `other_code` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;