								  	...
								  	<tr>
									    ...
									    <td>
									      	<div class="uploadlabelarea">
												...
												<tr>
									    <td>
											<div ondragenter="new uploader('<?php echo $email;?>','ajaxupload','U0')">
										     	<div class="uploadarea">
													<div class="drop" id="U0" ></div>
													<input type="file" id="U0_url"   name="U0"  style="display:none" onchange="readURL(this);"  />
												</div>
											</div>
									    </td>
									    <td>
